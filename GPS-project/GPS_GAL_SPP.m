function [dNEVs,Error_3D,Error_H] = GPS_GAL_SPP(eph,GIM_PATH,GS_RANGE,arrQM,gw)
addpath('modules/')
%% CONSTANTS
obsType = 103;
...
for ke = 1:NoEpochs
    ...
    NoSats = length(QM1e);
    clc;
    fprintf('GPS GAL SPP : epoch:\r%d/%d',ke,NoEpochs);
    ...
    for k1 = 1:MaxIter
        ...
        for kS = 1:NoSats
            ...
            elseif prn > 400 && prn < 500
                com = rho + x(5)  - CCC*dtSat + dIono + dTrop;
            end
