function [dNEVs,Error_3D,Error_H] = GPS_HAS(eph,GIM_PATH,GS_RANGE,arrQM,gw,gs_start)
addpath('modules/')
%% CONSTANTS
obsType = 103;
...
%% Load Has File
[orbit, clock, g_bias, ~]= read_has_mat(gw,gs_start);
...
%              STT = obs/CCC;
%              tc = gs - STT;
            [tc, STT] = calSTT(gs,vec_site,eph,ieph);
